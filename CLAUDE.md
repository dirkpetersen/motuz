...
Dev run — each in its own terminal; UI at http://localhost:8080 (webpack-dev-server proxies `/api`, `/swaggerui`, `/privacy` and `/terms` to Flask on :5000):
```bash
